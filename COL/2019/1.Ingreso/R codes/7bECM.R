...
fit <- readRDS("COL/2019/1.Ingreso/Data/fit_bayes.rds")
...
byAgrega <-
  grep(
    pattern =  "^(F|X|n|pobreza|ingreso|tasa_desocupacion|epred_mat|gk|depto|lp)",
...
openxlsx::write.xlsx(tablas, file = "COL/2019/1.Ingreso/Output/tablas_ECM.xlsx", 
                     overwrite = TRUE)
