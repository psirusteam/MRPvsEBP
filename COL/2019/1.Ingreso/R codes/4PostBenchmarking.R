...
fit <- readRDS("COL/2019/1.Ingreso/Data/fit_mrp_logshift.rds")
...
jpeg(file = "COL/2019/1.Ingreso/Output/Plot_Bench_Pobreza.jpeg")
hist(poststrat_df$gk)
dev.off()

saveRDS(poststrat_df %>% select(!matches("_\\d{,2}$")), 
        "COL/2019/1.Ingreso/Data/poststrat_df.RDS")
saveRDS(encuesta_mrp, "COL/2019/1.Ingreso/Data/encuesta_mrp.RDS")
