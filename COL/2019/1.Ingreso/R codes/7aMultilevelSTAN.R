...
saveRDS(fit, file = "COL/2019/1.Ingreso/Data/fit_bayes.rds")
# Assessment of the model -------------------------------------------------
#shinystan::launch_shinystan(fit)
############################################################
## Comparando los medelos Freq y Bayes
############################################################
# fit_freq <- readRDS("COL/2019/1.Ingreso/Data/fit_mrp_logshift.rds")[[1]]
# fit_Bayes <- readRDS("COL/2019/1.Ingreso/Data/fit_bayes.rds")
