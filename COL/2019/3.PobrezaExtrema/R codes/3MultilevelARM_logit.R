...
encuesta_mrp <- readRDS("COL/2019/3.PobrezaExtrema/Data/encuesta_mrp.rds") %>% 
  mutate(pobreza = ifelse(ingreso <= li, 1, 0))
...
saveRDS(fit, file = "COL/2019/3.PobrezaExtrema/Data/fit_mrp_logit.rds")

#--- Exporting Bayesian Multilevel Model Results ---#

fit <- readRDS(file = "COL/2019/3.PobrezaExtrema/Data/fit_mrp_logit.rds")
