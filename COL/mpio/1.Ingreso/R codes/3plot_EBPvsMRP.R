...
fit_freq_EBP <-
  readRDS("COL/mpio/1.Ingreso/Data/fit_freq_EBP_logshift.rds")

fit_bayes_mrp <-
  readRDS("COL/mpio/1.Ingreso/Data/fit_mrp_logshift.rds")
fit_freq_mrp <-
  readRDS("COL/mpio/1.Ingreso/Data/fit_freq_mrp_logshift.rds")
...
ggsave(plot = g, filename = "COL/mpio/1.Ingreso/Output/plot_EBPvsMRP.jpeg", scale = 4)
...
fit_freq_EBP <-
  readRDS("COL/mpio/1.Ingreso/Data/fit_freq_ebp_logit.rds")
fit_freq_mrp <-
  readRDS("COL/mpio/1.Ingreso/Data/fit_freq_mrp_logit.rds")
