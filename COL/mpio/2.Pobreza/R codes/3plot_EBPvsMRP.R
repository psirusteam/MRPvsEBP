...
fit_bayes_mrp <-
  readRDS("COL/mpio/2.Pobreza/Data/fit_mrp_logit.rds")
...
fit_freq_EBP <-
  readRDS("COL/mpio/2.Pobreza/Data/fit_freq_ebp_logit.rds")
fit_freq_mrp <-
  readRDS("COL/mpio/2.Pobreza/Data/fit_freq_mrp_logit.rds")
