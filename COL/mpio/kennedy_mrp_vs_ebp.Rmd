...
Adding in a quick check of the diagnostics

```{r}
library(tidybayes)
# Check transitions that ended with a divergence
# Code from: https://github.com/betanalpha/knitr_case_studies/issues/14
...
check_treedepth(fit_bayes_ebp_logshift)
check_div(fit_bayes_ebp_logshift)

check_treedepth(fit_bayes_mrp_logshift)
check_div(fit_bayes_mrp_logshift)
